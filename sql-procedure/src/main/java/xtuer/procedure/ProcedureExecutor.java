...
public class ProcedureExecutor {
    ...
    private static void setupProcedureParameters(CallableStatement stmt, Procedure procedure) throws SQLException {
        for (FunctionOrProcedureArg arg : procedure.getArgs()) {
            ...
            switch (arg.getArgTypeValue()) {
                ...
                case ProcedureArg.TYPE_INOUT:
                    ...
                    break;
                default:
                    System.out.println("设置参数: UNKNOWN Arg Type: " + arg.getArgTypeValue());
            }
        }
    }
    ...
    private static ProcedureResult getProcedureResult(CallableStatement stmt, Procedure procedure) throws SQLException {
        ...
        for (ProcedureArg arg : procedure.getArgs()) {
            ...
            } else if (arg.getArgTypeValue() == ProcedureArg.TYPE_OUT || arg.getArgTypeValue() == ProcedureArg.TYPE_INOUT) {
                // MySQL: 获取输出参数。
