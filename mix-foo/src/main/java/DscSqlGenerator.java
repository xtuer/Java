...
public class DscSqlGenerator {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("耗时: " + watch.elapsed(TimeUnit.MILLISECONDS) + " 毫秒");
    }

    public static void generateInsertSqls(int size) throws IOException {
        // 生成插入语句
        try (PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter(String.format("/Users/biao/Desktop/sqls/insert-sql-%d.sql", size))))) {
