...
public class UploadTest {
    ...
    public void testCreateUploadedFile() {
        UploadedFile uf = FileUploader.requestCreateUploadedFile("127.0.0.1", 8080, "/Users/biao/Downloads/arthas.zip", "/root/foo");
        System.out.println(uf);
    }

    @Test
    public void testRequestUploadedFile() {
        UploadedFile uf = FileUploader.requestUploadedFile("127.0.0.1", 8080, "fb9e041c2037a794cd8b1a44949f023e-ed642c96d27c32ac98c4cd41e4916e33");
        System.out.println(uf);
    }
    ...
    public void testUploadFileChunk() throws Exception {
        ...
        UploadedFile uf = FileUploader.requestCreateUploadedFile("127.0.0.1", 8080, srcPath, "/Users/biao/Downloads/temp");
        for (UploadedFileChunk chunk : uf.getChunks()) {
            chunk = FileUploader.uploadFileChunk("127.0.0.1", 8080, uf.getUid(), srcPath, chunk);
    ...
    public void testUploadBigFile() {
        FileUploader uploader = new FileUploader("127.0.0.1", 8080, "/Users/biao/Documents/workspace/win11-arm.iso", "/Users/biao/Downloads/temp");
        // FileUploader uploader = new FileUploader("127.0.0.1", 8080, "/Users/biao/Documents/workspace/win11-arm.iso", "/Users/biao/Downloads/temp");
    ...
    // DirUploader uploader = new DirUploader("192.168.12.101", 8080, "/Users/biao/Documents/temp/inter", "/root/x/y");
        DirUploader uploader = new DirUploader("127.0.0.1", 8080, "/Users/biao/Documents/temp/inter", "/Users/biao/Downloads/temp");
